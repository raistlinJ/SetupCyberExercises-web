...
class CreateStatusDetailApiTests(unittest.TestCase):
    ...
    def test_create_keeps_internet_connected_bridge_literal(self):
    ...
    def test_create_preserves_each_cloned_adapter_model_and_options(self):
        self.project.vms[0].internal_network_adaptors = ['lab', 'vmbr0']
        self.project.vms[0].internet_connected_adaptors = ['vmbr0']
        ...
        with ExitStack() as stack:
            ...
            prox.list_qemu_snapshots.return_value = []
            prox.get_qemu_config.return_value = {
                'net0': 'virtio=AA:BB:CC:DD:EE:01,bridge=old,firewall=1,queues=4',
                'net1': 'vmxnet3=AA:BB:CC:DD:EE:02,bridge=old,mtu=9000',
            }
            prox.set_qemu_options.return_value = None
            prox.list_network.return_value = []
            prox.create_bridge.return_value = None
        ...
        self.assertEqual(nets, [
            'virtio=AA:BB:CC:DD:EE:01,bridge=lab1,firewall=1,queues=4',
            'vmxnet3=AA:BB:CC:DD:EE:02,bridge=vmbr0,mtu=9000',
        ])
